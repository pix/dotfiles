...
# doc:zbinding:Ctrl-T:zsh:Paste the selected file path(s) into the command line.
__fzf_select() {
...
# doc:zbinding:Alt-C:zsh:Change directory with fzf.
fzf-cd-widget() {
  setopt localoptions pipefail no_aliases 2> /dev/null
  local dir="$(
...
# doc:zbinding:Ctrl-R:zsh:Search history with fzf.
fzf-history-widget() {
  local selected num
